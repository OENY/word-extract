...
function attachDOMEventsToEventBus(eventBus) {
  ...
  eventBus.on('find', function (evt) {
    ...
    window.dispatchEvent(event);//触发查询事件
  });
...
var PDFFindController = function () {
  ...
  _createClass(PDFFindController, [{
    ...
    key: 'nextMatch',//执行搜索词匹配
    value: function nextMatch() {
      var _this4 = this;

      var previous = this.state.findPrevious;
      var currentPageIndex = this.pdfViewer.currentPageNumber - 1;//他是如何通过this.pdfViewer来获取当前页码的
...
var TextLayerBuilder = function () {
  ...
  _createClass(TextLayerBuilder, [{
    ...
    value: function updateMatches() {
      ...
      this.matches = this.convertMatches(pageMatches, pageMatchesLength);//通过convertMatches获得所匹配的所有词的位置，在当前页？
...
//var DEFAULT_URL = 'compressed.tracemonkey-pldi-09.pdf';
        // var DEFAULT_URL = 'JavaScript高级程序设计（第3版）非扫描版.pdf';
